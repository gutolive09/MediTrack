    ...
    <>
      <section className="relative h-screen">
        <h1 className="text-6xl text-white m-32 w-1/2">
          Nunca foi tão <span className="text-[--verde-primario]">facil</span> acompanhar
          sua rotina médica
        </h1>
        <Image
      ...
      <section className="text-white text-center">
        <h2 className="text-5xl my-9">
          Conheça o <span className="font-semibold text-[--verde-primario]">MediTracker</span>
        </h2>
        <h3 className="text-3xl mb-10">O App que pensa nas suas consultas por você</h3>
        <div>
          <div className="flex justify-center">
            <div className="w-1/3 mt-14 mr-20">
              <h4 className="text-2xl m-2 text-[--verde-primario]">Gestão de consultas</h4>
              <p>
          ...
          <div className="flex justify-center mt-7 mb-7">
            ...
            <div className="w-1/3 mt-14">
              <h4 className="text-2xl m-2 text-[--verde-primario]">Lembretes detalhados</h4>
              <p>
          ...
          <div className="flex justify-center">
            <div className="w-1/3 mt-14 mr-20">
              <h4 className="text-2xl m-2 text-[--verde-primario]">Triagem de Sintomas</h4>
              <p>
